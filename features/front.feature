Feature: Test homepage
  ...
  Scenario Outline: Test Front End URLs as an anonymous
    ...
    Scenario: Test submition for Check promise
      Given I am on the homepage
       When I select "TEST" from "donate[affectations]"
       And I fill in "donate_firstName" with "Unit"
       And I fill in "donate_lastName" with "Test"
       And I fill in "donate_email_first" with "behat@ecedi.fr"
       And I fill in "donate_email_second" with "behat@ecedi.fr"
       And I fill in "donate_addressStreet" with "77 rue du Paradis"
       And I fill in "donate_addressZipcode" with "75010"
       And I fill in "donate_addressCity" with "Paris"
       And I press "donate_payment_method_check_promise"
       Then the response status code should be 200
       And I should see "Merci pour votre don par chèque"

    Scenario: Test submition for CB spot payment with ogone
      Given I am on the homepage
       When I select "ALL" from "donate[affectations]"
       And I fill in "donate_firstName" with "Unit"
       And I fill in "donate_lastName" with "Test"
       And I fill in "donate_email_first" with "behat@ecedi.fr"
       And I fill in "donate_email_second" with "behat@ecedi.fr"
       ...
       And I fill in "donate_addressZipcode" with "75010"
       And I fill in "donate_addressCity" with "Paris"
       And I press "donate_payment_method_ogone"
       Then the response status code should be 200
    ...
    Scenario: Test submition for Offline SEPA recurung payment
      Given I am on the homepage
       When I select "" from "donate[tunnels][spot][preselected]"
       And I select "10" from "donate[tunnels][recuring][preselected]"
       And I fill in "donate_firstName" with "Unit"
       And I fill in "donate_lastName" with "Test"
       And I fill in "donate_email_first" with "behat@ecedi.fr"
       And I fill in "donate_email_second" with "behat@ecedi.fr"
       ...
       And I fill in "donate_addressZipcode" with "75010"
       And I fill in "donate_addressCity" with "Paris"
       And I press "donate_payment_method_sepa_offline"
       Then the response status code should be 200
